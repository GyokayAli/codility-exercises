...
namespace _10.MaxCounters
{
    class Program
    {
        static void Main(string[] args)
        {
            var result = FindMaxCounters(5, new int[] { 3, 4, 4, 6, 1, 4, 4 });
         ...
         * The input given above as an example should return [3, 2, 2, 4, 2]
         * 
        ...
        public static int[] FindMaxCounters(int N, int[] A)
        {
            ...
            for (int i = 0; i < A.Length; i++)
            {
                ...
                else
                {
                    ...
                    lastResetCounter = Math.Max(lastResetCounter, counters[index]);
                }
            }
